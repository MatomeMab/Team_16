...
namespace Nazox.Controllers.JobListings
{
    public class JobListingsController : Controller
    {
        ...
        public async Task<ActionResult> Index(int ?id)
        {
            ...
            var jobListings = db.JobListings.Include(j => j.ListingStatu);
        ...
        public async Task<ActionResult> Details(int? ids,int?id)
        {
            ...
            JobListing jobListing = await db.JobListings.FindAsync(ids);
            if (jobListing == null)
            {
                return HttpNotFound();
            }
        ...
        public async Task<ActionResult> Create(int?id)
        {
            ...
            ViewBag.ListingStatus_ID = new SelectList(db.ListingStatus, "ListingStatus_ID", "ListingStatusName");
            return View();
        }
        ...
        public async Task<ActionResult> Create([Bind(Include = "Job_ID,Description,Amount,ListingStatus_ID,DatePosted,ExpiryDate")] JobListing jobListing,int?id)
        {
            /*NAVIGATION*/
            User tblUser = await db.Users.FindAsync(id);
            if (tblUser == null)
            ...
            ViewBag.ListingStatus_ID = new SelectList(db.ListingStatus, "ListingStatus_ID", "ListingStatusName", jobListing.ListingStatus_ID);
            return View(jobListing);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Job_ID,Description,Amount,ListingStatus_ID,DatePosted,ExpiryDate")] JobListing jobListing,int?id)
        {
